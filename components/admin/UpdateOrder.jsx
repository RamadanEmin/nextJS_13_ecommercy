        ...
        <article className="p-3 lg:p-5 mb-5 bg-white border border-blue-600 rounded-md">
            ...
            <div className="grid md:grid-cols-3 gap-2">
                ...
                <div>
                    ...
                    <ul className="text-gray-600">
                        ...
                        <li>Tax paid: {order?.paymentInfo?.taxPaid} лв.</li>
                        <li>Total paid: {order?.paymentInfo?.amountPaid} лв.</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-2">
                {order?.orderItems?.map((item) => (
                    <figure key={order?._id} className="flex flex-row mb-4">
                        <div>
                        ...
                        <figcaption className="ml-3">
                            ...
                            <p className="mt-1 font-semibold">{item.quantity}x = {item.price * item.quantity} лв.</p>
                        </figcaption>
                    </figure>
                ))}
            </div>
