                            ...
                            <article className="text-gray-600" style={{ maxWidth: "350px" }}>
                                ...
                                <ul>
                                    <li className="flex justify-between mb-1">
                                        <span>Amount:</span>
                                        <span>{cart?.checkoutInfo?.amount} лв.</span>
                                    </li>
                                    <li className="flex justify-between mb-1">
                                        <span>Est TAX:</span>
                                        <span>{cart?.checkoutInfo?.tax} лв.</span>
                                    </li>
                                    <li className="border-t flex justify-between mt-3 pt-3">
                                        <span>Total Amount:</span>
                                        <span className="text-gray-900 font-bold">{cart?.checkoutInfo?.totalAmount} лв.</span>
                                    </li>
                                </ul>
                                ...
                                {cart?.cartItems?.map((item) => (
                                    <figure class="flex items-center mb-4 leading-5">
                                        ...
                                        <figcaption class="ml-3">
                                            ...
                                            <p class="mt-1 text-gray-400">Total: {item.quantity * item.price} лв.</p>
                                        </figcaption>
                                    </figure>
                                ))}
                            </article>
